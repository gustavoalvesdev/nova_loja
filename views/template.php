				...
				<ul class="nav navbar-nav">
					...
					<?php if (isset($viewData['category_filter'])) : ?>
						<?php foreach ($viewData['category_filter'] as $cf) : ?>
							<li><a href="<?php echo BASE_URL; ?>categories/enter/<?php echo $cf['id']; ?>"><?php echo $cf['name']; ?></a>
							</li>
						<?php endforeach; ?>
					<?php endif; ?>
				</ul>
						...
						<div class="filterarea">
								...
								<div class="filtercontent">
									<?php foreach ($viewData['filters']['brands'] as $bitem) : ?>
										<div class="filteritem">
											<input type="checkbox" name="filter[brand][]" value="<?php echo $bitem['id']; ?>" id="filter_brand<?php echo $bitem['id']; ?>"> <label for="filter_brand<?php echo $bitem['id']; ?>">
											</label>
											<?php echo $bitem['name']; ?> <span style="float:right;">(<?php echo $bitem['count']; ?>)</span>
										</div>
									<?php endforeach; ?>
								</div>
							</div>
							...
							<div class="filterbox">
								...
								<div class="filtercontent">
									...
									<div class="filteritem">
										<input type="checkbox" name="filter[star][]" value="0" id="filter_star0"> <label for="filter_star0">
									...
									<div class="filteritem">
										<input type="checkbox" name="filter[star][]" value="3" id="filter_star3"> <label for="filter_star3">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
										</label>
									...
									<div class="filteritem">
										<input type="checkbox" name="filter[star][]" value="4" id="filter_star4"> <label for="filter_star4">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
									...
									<div class="filteritem">
										<input type="checkbox" name="filter[star][]" value="5" id="filter_star5"> <label for="filter_star5">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
											<img src="<?php echo BASE_URL ?>assets/images/star.png" border="0" height="13">
							...
							<div class="filterbox">
								...
								<div class="filtercontent">
									<?php print_r($viewData['filters']['options']); ?>
								</div>
							</div>
