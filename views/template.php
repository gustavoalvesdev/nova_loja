...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/jquery-ui.min.structure.css" type="text/css" />
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown"
                            href="#"><?= $this->lang->get('SELECTCATEGORY'); ?>
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li><a
                            href="<?php echo BASE_URL; ?>categories/enter/<?php echo $cf['id']; ?>"><?php echo $cf['name']; ?></a>
                    </li>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </ul>
                        ...
                        <div class="filterarea">
                            <div class="filterbox">
                                ...
                                <div class="filtercontent">
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[brand][]"
                            ...
                            <div class="filterbox">
                                ...
                                <div class="filtercontent">
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[star][]" value="0" id="filter_star0"> <label
                                            for="filter_star0">
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[star][]" value="1" id="filter_star1"> <label
                                            for="filter_star1">
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[star][]" value="2" id="filter_star2"> <label
                                            for="filter_star2">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                                height="13">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[star][]" value="3" id="filter_star3"> <label
                                            for="filter_star3">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                                height="13">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[star][]" value="4" id="filter_star4"> <label
                                            for="filter_star4">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                                height="13">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[star][]" value="5" id="filter_star5"> <label
                                            for="filter_star5">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                                                height="13">
                                            <img src="<?php echo BASE_URL ?>assets/images/star.png" border="0"
                            ...
                            <div class="filterbox">
                                ...
                                <div class="filtercontent">
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[sale]" id="filter_sale"> <label
                                            for="filter_sale">Em promoção</label>
                            ...
                            <div class="filterbox">
                                ...
                                <div class="filtercontent">
                                    ...
                                    <div class="filteritem">
                                        <input type="checkbox" name="filter[options][]" value="<?php echo $op['id']; ?>"
    ...
    <footer>
        ...
        <div class="links">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <a href="<?php echo BASE_URL; ?>"><img width="150"
                                src="<?php echo BASE_URL; ?>assets/images/logo.png" /></a><br /><br />
